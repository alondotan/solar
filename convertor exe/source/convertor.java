...
public class convertor extends PApplet {
...
public void t(String t,int l){
       println(t);
      fill(0,0,0);
       text(t,TEXT_START_X,TEXT_START_Y + l*TEXT_NEW_LINE);  
}

public float GetAngleABC( PVector p1, PVector p2, PVector p3 )
{
  float  s1 = p2.dist(p3);
  float  s2 = p1.dist(p3);
  float  s3 = p2.dist(p1);
